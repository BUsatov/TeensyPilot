...
#define ATT_P_YAW   0.0f
#define ATT_I_YAW   0.0f
#define ATT_D_YAW   0.0f

// Rate PID gains (dps -> motor mix us)
#define RATE_P_ROLL  1.0f
#define RATE_I_ROLL  0.0f
#define RATE_D_ROLL  0.2f

#define RATE_P_PITCH 1.0f
#define RATE_I_PITCH 0.0f
#define RATE_D_PITCH 0.2f

#define RATE_P_YAW   1.0f
#define RATE_I_YAW   0.0f
#define RATE_D_YAW   0.1f
